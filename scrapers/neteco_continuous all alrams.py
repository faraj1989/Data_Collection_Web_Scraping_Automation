...
ALL_ALARMS_URL = env_str(
    "NETECO_ALL_ALARMS_URL",
...
def navigate_to_all_alarms(driver):
...
def run_export_sequence(driver):
    ...
    new_name = f"NetEco_All_Current_Alarm_{time.strftime('%Y%m%d_%H%M%S')}{extension}"
